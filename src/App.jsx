...
import { BoardingStudentList } from './pages/BoardingStudentList';
  ...
  return (
    <div className="app-shell">
      ...
      <Routes>
        ...
        <Route path="/boarding-students" element={<ProtectedRoute><MainLayout><BoardingStudentList /></MainLayout></ProtectedRoute>} />
