...
export function AccountSettings() {
  ...
  return (
    <>
      <div className="header-container" style={{ display: 'flex', alignItems: 'center', padding: '16px', background: 'var(--bg-card)', borderBottom: '1px solid var(--border-color)', position: 'sticky', top: 0, zIndex: 10 }}>
      ...
      <div className="settings-content" style={{ padding: '20px', paddingBottom: '120px' }}>
        <Card className="mb-4">
          <CardBody>
